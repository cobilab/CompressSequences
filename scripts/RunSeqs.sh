...
for GENOME in "${GENOMES[@]}"; do
    ...
    if [[ "$*" == *"--installed-with-conda"* ||  "$*" == *"-iwc"* ]]; then
      ...
      #
      RUN_PAQ8 "$GENOME" "paq8l -1 " "paq8l -d " "PAQ8L-1" "$((run+=1))"
      RUN_PAQ8 "$GENOME" "paq8l -2 " "paq8l -d " "PAQ8L-2" "$((run+=1))"
      RUN_PAQ8 "$GENOME" "paq8l -3 " "paq8l -d " "PAQ8L-3" "$((run+=1))"
      RUN_PAQ8 "$GENOME" "paq8l -4 " "paq8l -d " "PAQ8L-4" "$((run+=1))"
      RUN_PAQ8 "$GENOME" "paq8l -5 " "paq8l -d " "PAQ8L-5" "$((run+=1))"
      RUN_PAQ8 "$GENOME" "paq8l -6 " "paq8l -d " "PAQ8L-6" "$((run+=1))"
      RUN_PAQ8 "$GENOME" "paq8l -7 " "paq8l -d " "PAQ8L-7" "$((run+=1))"
      RUN_PAQ8 "$GENOME" "paq8l -8 " "paq8l -d " "PAQ8L-8" "$((run+=1))"
    else
